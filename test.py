...
# getting_help_classes = scoring_df.iloc[:,-1]
# fig,ax = plot_bar(classes=getting_help_classes,n_question = len(getting_help_classes.notna()),
#                           category_order=["I donot want to answer this question","Yes, I have used them and I was satisfied",
#                                           "Yes, I have used them, but I was not satisfied","Yes, but I have never used them",
...
# scoring_df= impact_of_MH(survey_data.get_responses("D6"))
# MH_impact = scoring_df.iloc[:,-1]
# fig,ax = plot_bar(classes=MH_impact,n_question = len(MH_impact.notna()),
